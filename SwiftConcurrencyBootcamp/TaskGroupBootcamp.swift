  ...
  //
  //  Created by Ayoola Abimbola on 3/29/26.
  //
...
class TaskGroupBootcampDataManager {
  ...
  func fetchImagesWithTaskGroup() async throws -> [UIImage] {
    let urlStrings: [String] = ["https://picsum.photos/300", "https://picsum.photos/300", "https://picsum.photos/300", "https://picsum.photos/300", "https://picsum.photos/300"]
...
struct TaskGroupBootcamp: View {
  @State private var viewModel: TaskGroupBootcampViewModel = TaskGroupBootcampViewModel()
